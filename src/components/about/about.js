                ...
                <div className="about-cont">
                    ...
                    <div className="about-sec">
                        <div className={`about-right ${view ? 'elementFadeup' : 'zero-opac'}`}>
                            <p>
                                Hello! I’m Kartheek G, a full stack web developer based in Dallas, TX.
                            </p>
                            <p>
                                I am a graduate student persuing Masters in Computer Science <span className="green">@ Lamar University</span>, I combine my education with 3 years of experience as front-end web developer.
                            </p>
                            <p>
                                I love applying responsive design principle and watching my web pages shrink into mobile screens. It's oddly satisfying.
                            </p>
                            <p>
                                When I am not coding or pushing pixels, you'll find me travelling, clicking photos, and writing or reading poetry,.
                            </p>
                        </div>
